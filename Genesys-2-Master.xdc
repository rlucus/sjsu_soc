...
create_clock -period 5.000 -name clk450MHz -waveform {0.000 2.500} [get_ports sysclk_p]
...
set_property -dict {PACKAGE_PIN N19 IOSTANDARD LVCMOS12} [get_ports {switch[4]}]
set_property -dict {PACKAGE_PIN P19 IOSTANDARD LVCMOS12} [get_ports {switch[5]}]
set_property -dict {PACKAGE_PIN P26 IOSTANDARD LVCMOS33} [get_ports {switch[6]}]
set_property -dict {PACKAGE_PIN P27 IOSTANDARD LVCMOS33} [get_ports {switch[7]}]

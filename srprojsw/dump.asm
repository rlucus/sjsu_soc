...
0x00000218  0x8c1a7ee0  lw $26,32480($0)      229      lw $k0, 0x7EE0($zero)
0x0000021c  0x03400008  jr $26                230      jr $k0
0x00000220  0x03e00008  jr $31                232      jr $ra # Shouldn't go here
0x00000224  0xac087eec  sw $8,32492($0)       245      sw $t0, 0x7EEC($zero) # Save $t0 to RAM, I need it
0x00000228  0x8c1a7ec0  lw $26,32448($0)      247      lw $k0, 0x7EC0($zero) # Load interrupt status to memory (Note: CP0/R13 no longer viable as interrupts reset)
0x0000022c  0x201b007c  addi $27,$0,124       248      addi $k1, $zero, 0x007C # N2: Mask out everything except exception code
0x00000230  0x035bd824  and $27,$26,$27       249      and  $k1, $k0, $k1
0x00000234  0x001bd882  srl $27,$27,2         250      srl $k1, $k1, 0x2
0x00000238  0xac1b7020  sw $27,28704($0)      251      sw  $k1, 0x7020($zero) # Store it to memory
0x0000023c  0x13600001  beq $27,$0,1          253      beq $k1, $zero, IS_INTR # Would do a bne here, but not available in the arch, hence this skip-step if
0x00000240  0x10000034  beq $0,$0,52          254      beq $zero, $zero, OTHER_EXCP
0x00000244  0x001ad202  srl $26,$26,8         257          srl $k0, $k0, 0x8 # N3: Look at the interrupt flags
0x00000248  0x201b00ff  addi $27,$0,255       258          addi $k1, $zero, 0xFF
0x0000024c  0x037ad024  and $26,$27,$26       259          and $k0, $k1, $k0
0x00000250  0x201b0080  addi $27,$0,128       261          addi $k1, $zero, 0x80 # N4: Case HWINTR5 (also for next few blocks for different interrupts)
0x00000254  0x001b4020  add $8,$0,$27         262          add $t0, $zero, $k1
0x00000258  0x035bd824  and $27,$26,$27       263          and $k1, $k0, $k1
0x0000025c  0x1368001d  beq $27,$8,29         264          beq $k1, $t0, CASE_HWINTR5
0x00000260  0x201b0040  addi $27,$0,64        266          addi $k1, $zero, 0x40
0x00000264  0x001b4020  add $8,$0,$27         267          add $t0, $zero, $k1
0x00000268  0x035bd824  and $27,$26,$27       268          and $k1, $k0, $k1
0x0000026c  0x1368001e  beq $27,$8,30         269          beq $k1, $t0, CASE_HWINTR4
0x00000270  0x201b0020  addi $27,$0,32        271          addi $k1, $zero, 0x20
0x00000274  0x001b4020  add $8,$0,$27         272          add $t0, $zero, $k1
0x00000278  0x035bd824  and $27,$26,$27       273          and $k1, $k0, $k1
0x0000027c  0x1368001a  beq $27,$8,26         274          beq $k1, $t0, CASE_HWINTR3
0x00000280  0x201b0010  addi $27,$0,16        276          addi $k1, $zero, 0x10
0x00000284  0x001b4020  add $8,$0,$27         277          add $t0, $zero, $k1
0x00000288  0x035bd824  and $27,$26,$27       278          and $k1, $k0, $k1
0x0000028c  0x13680016  beq $27,$8,22         279          beq $k1, $t0, CASE_HWINTR2
0x00000290  0x201b0008  addi $27,$0,8         281          addi $k1, $zero, 0x08
0x00000294  0x001b4020  add $8,$0,$27         282          add $t0, $zero, $k1
0x00000298  0x035bd824  and $27,$26,$27       283          and $k1, $k0, $k1
0x0000029c  0x13680012  beq $27,$8,18         284          beq $k1, $t0, CASE_HWINTR1
0x000002a0  0x201b0004  addi $27,$0,4         286          addi $k1, $zero, 0x04
0x000002a4  0x001b4020  add $8,$0,$27         287          add $t0, $zero, $k1
0x000002a8  0x035bd824  and $27,$26,$27       288          and $k1, $k0, $k1
0x000002ac  0x13680010  beq $27,$8,16         289          beq $k1, $t0, CASE_HWINTR0 # TODO: Compare with zero incorrect, fix this (fixed)
0x000002b0  0x201b0002  addi $27,$0,2         291          addi $k1, $zero, 0x02
0x000002b4  0x001b4020  add $8,$0,$27         292          add $t0, $zero, $k1
0x000002b8  0x035bd824  and $27,$26,$27       293          and $k1, $k0, $k1
0x000002bc  0x1368000f  beq $27,$8,15         294          beq $k1, $t0, CASE_SWINTR1
0x000002c0  0x201b0001  addi $27,$0,1         296          addi $k1, $zero, 0x01
0x000002c4  0x001b4020  add $8,$0,$27         297          add $t0, $zero, $k1
0x000002c8  0x035bd824  and $27,$26,$27       298          and $k1, $k0, $k1
0x000002cc  0x1368000e  beq $27,$8,14         299          beq $k1, $t0, CASE_SWINTR0
0x000002d0  0x10000013  beq $0,$0,19          301          beq $zero, $zero, END_IS_INTR
...
0x000002e0  0x8c1f7ec8  lw $31,32456($0)      307              lw $ra, 0x7EC8($zero)
0x000002e4  0x1000000e  beq $0,$0,14          308              beq $zero, $zero, END_IS_INTR
0x000002e8  0xac08702c  sw $8,28716($0)       313              sw $t0, 0x702C($zero)
0x000002ec  0x1000000c  beq $0,$0,12          314              beq $zero, $zero, END_IS_INTR # Hardware interrupts 1 through 4 ignored, simply note and reset them
0x000002f0  0xac087028  sw $8,28712($0)       316              sw $t0, 0x7028($zero) # Signal that AES is now complete (make sure A0 has 1 in it!)
0x000002f4  0x00000000  nop                   317              nop # Why did I put this here? I'll keep it for now . . .
0x000002f8  0x10000009  beq $0,$0,9           318              beq $zero, $zero, END_IS_INTR
0x000002fc  0x20080011  addi $8,$0,17         320              addi $t0, $zero, 0x11
0x00000300  0xac087024  sw $8,28708($0)       321              sw $t0, 0x7024($zero)
0x00000304  0x10000006  beq $0,$0,6           322              beq $zero, $zero, END_IS_INTR
0x00000308  0x20080010  addi $8,$0,16         324              addi $t0, $zero, 0x10
0x0000030c  0xac087024  sw $8,28708($0)       325              sw $t0, 0x7024($zero)
0x00000310  0x10000003  beq $0,$0,3           326              beq $zero, $zero, END_IS_INTR
0x00000314  0x8c1a7ee0  lw $26,32480($0)      329          lw $k0, 0x7EE0($zero)
0x00000318  0x235a0004  addi $26,$26,4        330          addi $k0, $k0, 0x4 # Skip offending instruction (ref: http://www.cs.uwm.edu/classes/cs315/Bacon/Lecture/HTML/ch15s10.html)
...
0x00000334  0xaf7a007c  sw $26,124($27)       344      sw $k0, 124($k1)
0x00000338  0x201a0000  addi $26,$0,0         345      addi $k0, $0, 0
0x0000033c  0x375a00ff  ori $26,$26,255       347      ori  $k0, $k0, 0x00FF
0x00000340  0xaf7a0078  sw $26,120($27)       348      sw   $k0, 120($k1) # $fp = last addr in task
0x00000344  0xaf7a0074  sw $26,116($27)       349      sw   $k0, 116($k1) # $sp = $fp
0x00000348  0x201b6100  addi $27,$0,24832     351      addi $k1, $0, 0x6100
0x0000034c  0x201a07a0  addi $26,$0,1952      353      la $k0, task1Start
0x00000350  0xaf7a0000  sw $26,0($27)         354      sw $k0, 0($k1)
0x00000354  0xaf7a007c  sw $26,124($27)       355      sw $k0, 124($k1)
0x00000358  0x201a0001  addi $26,$0,1         356      addi $k0, $0, 1
0x0000035c  0x001ad200  sll $26,$26,8         357      sll  $k0, $k0, 0x0008
0x00000360  0x375a00ff  ori $26,$26,255       358      ori  $k0, $k0, 0x00FF
0x00000364  0xaf7a0078  sw $26,120($27)       359      sw   $k0, 120($k1)
0x00000368  0xaf7a0074  sw $26,116($27)       360      sw   $k0, 116($k1)
0x0000036c  0x201b6200  addi $27,$0,25088     362      addi $k1, $0, 0x6200
0x00000370  0x201a0ff8  addi $26,$0,4088      364      la $k0, task2Start
0x00000374  0xaf7a0000  sw $26,0($27)         365      sw $k0, 0($k1)
0x00000378  0xaf7a007c  sw $26,124($27)       366      sw $k0, 124($k1)
0x0000037c  0x201a0002  addi $26,$0,2         367      addi $k0, $0, 2
0x00000380  0x001ad200  sll $26,$26,8         368      sll  $k0, $k0, 0x0008
0x00000384  0x375a00ff  ori $26,$26,255       369      ori  $k0, $k0, 0x00FF
0x00000388  0xaf7a0078  sw $26,120($27)       370      sw   $k0, 120($k1)
0x0000038c  0xaf7a0074  sw $26,116($27)       371      sw   $k0, 116($k1)
0x00000390  0x201b6300  addi $27,$0,25344     373      addi $k1, $0, 0x6300
0x00000394  0x201a0ff8  addi $26,$0,4088      375      la $k0, task3Start
0x00000398  0xaf7a0000  sw $26,0($27)         376      sw $k0, 0($k1)
0x0000039c  0xaf7a007c  sw $26,124($27)       377      sw $k0, 124($k1)
0x000003a0  0x201a0003  addi $26,$0,3         378      addi $k0, $0, 3
0x000003a4  0x001ad200  sll $26,$26,8         379      sll  $k0, $k0, 0x0008
0x000003a8  0x375a00ff  ori $26,$26,255       380      ori  $k0, $k0, 0x00FF
0x000003ac  0xaf7a0078  sw $26,120($27)       381      sw   $k0, 120($k1)
0x000003b0  0xaf7a0074  sw $26,116($27)       382      sw   $k0, 116($k1)
0x000003b4  0x201b6400  addi $27,$0,25600     384      addi $k1, $0, 0x6400
0x000003b8  0x201a0ff8  addi $26,$0,4088      386      la $k0, task4Start
0x000003bc  0xaf7a0000  sw $26,0($27)         387      sw $k0, 0($k1)
0x000003c0  0xaf7a007c  sw $26,124($27)       388      sw $k0, 124($k1)
0x000003c4  0x201a0004  addi $26,$0,4         389      addi $k0, $0, 4
0x000003c8  0x001ad200  sll $26,$26,8         390      sll  $k0, $k0, 0x0008
0x000003cc  0x375a00ff  ori $26,$26,255       391      ori  $k0, $k0, 0x00FF
0x000003d0  0xaf7a0078  sw $26,120($27)       392      sw   $k0, 120($k1)
0x000003d4  0xaf7a0074  sw $26,116($27)       393      sw   $k0, 116($k1)
0x000003d8  0x201b6500  addi $27,$0,25856     395      addi $k1, $0, 0x6500
0x000003dc  0x201a0ff8  addi $26,$0,4088      397      la $k0, task5Start
0x000003e0  0xaf7a0000  sw $26,0($27)         398      sw $k0, 0($k1)
0x000003e4  0xaf7a007c  sw $26,124($27)       399      sw $k0, 124($k1)
0x000003e8  0x201a0005  addi $26,$0,5         400      addi $k0, $0, 5
0x000003ec  0x001ad200  sll $26,$26,8         401      sll  $k0, $k0, 0x0008
0x000003f0  0x375a00ff  ori $26,$26,255       402      ori  $k0, $k0, 0x00FF
0x000003f4  0xaf7a0078  sw $26,120($27)       403      sw   $k0, 120($k1)
0x000003f8  0xaf7a0074  sw $26,116($27)       404      sw   $k0, 116($k1)
0x000003fc  0x201b6600  addi $27,$0,26112     406      addi $k1, $0, 0x6600
0x00000400  0x201a0ff8  addi $26,$0,4088      408      la $k0, task6Start
0x00000404  0xaf7a0000  sw $26,0($27)         409      sw $k0, 0($k1)
0x00000408  0xaf7a007c  sw $26,124($27)       410      sw $k0, 124($k1)
0x0000040c  0xac1a7ee0  sw $26,32480($0)      411      sw $k0, 0x7EE0($0)  # should be first address of iMEM for task6
0x00000410  0xac1a7ee4  sw $26,32484($0)      412      sw $k0, 0x7EE4($0)  # this should be where INTR passes RA
0x00000414  0x201a0006  addi $26,$0,6         413      addi $k0, $0, 6
0x00000418  0x001ad200  sll $26,$26,8         414      sll  $k0, $k0, 0x0008
0x0000041c  0x375a00ff  ori $26,$26,255       415      ori  $k0, $k0, 0x00FF
0x00000420  0xaf7a0078  sw $26,120($27)       416      sw   $k0, 120($k1)
0x00000424  0xaf7a0074  sw $26,116($27)       417      sw   $k0, 116($k1)
0x00000428  0x201a7fe0  addi $26,$0,32736     420      addi   $k0,  $0, 0x7FE0      # [xxxxxxxxx| 1 | 6543210 | 6543210 ]
...
0x00000444  0x201a7fe0  addi $26,$0,32736     438      addi $k0,  $0, 0x7FE0
0x00000448  0x8f5f0000  lw $31,0($26)         443      lw $31, 0($k0) #load status register
0x0000044c  0x20080001  addi $8,$0,1          447      addi $8, $0, 1
0x00000450  0x000841c0  sll $8,$8,7           448      sll $8, $8, 7
0x00000454  0x03e8d024  and $26,$31,$8        450      and $k0, $31, $8
0x00000458  0x17400012  bne $26,$0,18         451      bne $k0, $0, caseSchedTask0  #if (mask & statusReg != 0)
0x0000045c  0x00084040  sll $8,$8,1           453      sll $8, $8, 1
0x00000460  0x03e8d024  and $26,$31,$8        454      and $k0, $31, $8
0x00000464  0x17400011  bne $26,$0,17         455      bne $k0, $0, caseSchedTask1    
0x00000468  0x00084040  sll $8,$8,1           457      sll $8, $8, 1
0x0000046c  0x03e8d024  and $26,$31,$8        458      and $k0, $31, $8
0x00000470  0x17400010  bne $26,$0,16         459      bne $k0, $0, caseSchedTask2  
0x00000474  0x00084040  sll $8,$8,1           461      sll $8, $8, 1
0x00000478  0x03e8d024  and $26,$31,$8        462      and $k0, $31, $8
0x0000047c  0x1740000f  bne $26,$0,15         463      bne $k0, $0, caseSchedTask3  
0x00000480  0x00084040  sll $8,$8,1           465      sll $8, $8, 1
0x00000484  0x03e8d024  and $26,$31,$8        466      and $k0, $31, $8
0x00000488  0x1740000e  bne $26,$0,14         467      bne $k0, $0, caseSchedTask4  
0x0000048c  0x00084040  sll $8,$8,1           469      sll $8, $8, 1
0x00000490  0x03e8d024  and $26,$31,$8        470      and $k0, $31, $8
0x00000494  0x1740000d  bne $26,$0,13         471      bne $k0, $0, caseSchedTask5
0x00000498  0x00084040  sll $8,$8,1           473      sll $8, $8, 1
0x0000049c  0x03e8d024  and $26,$31,$8        474      and $k0, $31, $8
0x000004a0  0x1740000c  bne $26,$0,12         475      bne $k0, $0, caseSchedTask6
0x000004a4  0x201a6000  addi $26,$0,24576     482      addi $k0, $0, 0x6000
0x000004a8  0x1000000b  beq $0,$0,11          483      beq $zero, $zero, caseSchedTaskEnd
0x000004ac  0x201a6100  addi $26,$0,24832     485      addi $k0, $0, 0x6100
0x000004b0  0x10000009  beq $0,$0,9           486      beq $zero, $zero, caseSchedTaskEnd
0x000004b4  0x201a6200  addi $26,$0,25088     488      addi $k0, $0, 0x6200
0x000004b8  0x10000007  beq $0,$0,7           489      beq $zero, $zero, caseSchedTaskEnd
0x000004bc  0x201a6300  addi $26,$0,25344     491      addi $k0, $0, 0x6300
0x000004c0  0x10000005  beq $0,$0,5           492      beq $zero, $zero, caseSchedTaskEnd
0x000004c4  0x201a6400  addi $26,$0,25600     494      addi $k0, $0, 0x6400
0x000004c8  0x10000003  beq $0,$0,3           495      beq $zero, $zero, caseSchedTaskEnd
0x000004cc  0x201a6500  addi $26,$0,25856     497      addi $k0, $0, 0x6500
0x000004d0  0x10000001  beq $0,$0,1           498      beq $zero, $zero, caseSchedTaskEnd
0x000004d4  0x201a6600  addi $26,$0,26112     500      addi $k0, $0, 0x6600
0x000004d8  0x0008da02  srl $27,$8,8          503      srl $k1, $8, 8   #8 because I want it to be 0 if task0 is running
0x000004dc  0xac1b7fe4  sw $27,32740($0)      504      sw $k1, 0x7FE4($0)    #set aside current running task number for later
0x000004e0  0x3c010000  lui $1,0              505      addi $k1, $0, 0xFFFF
0x000004e4  0x3421ffff  ori $1,$1,65535            
...
0x000004f4  0xac1f7fe0  sw $31,32736($0)      508      sw $31, 0x7FE0($0) #update sched status
0x000004f8  0x8c087ee0  lw $8,32480($0)       515      lw $8, 0x7EE0($0)
0x000004fc  0xaf480000  sw $8,0($26)          516      sw $8, 0($k0) #PC saved into register 0 spot... 
0x00000500  0x8c1f7ee4  lw $31,32484($0)      520      lw $ra, 0x7EE4($0) #retrieve passed RA from memory 0x7ee0 INTR passes here
0x00000504  0x8c087eec  lw $8,32492($0)       522      lw $t0, 0x7EEC($0)
0x00000508  0xaf410004  sw $1,4($26)          525      sw $1,  4($k0)
0x0000050c  0xaf420008  sw $2,8($26)          526      sw $2,  8($k0)
0x00000510  0xaf43000c  sw $3,12($26)         527      sw $3,  12($k0) 
0x00000514  0xaf440010  sw $4,16($26)         528      sw $4,  16($k0)
0x00000518  0xaf450014  sw $5,20($26)         529      sw $5,  20($k0)
0x0000051c  0xaf460018  sw $6,24($26)         530      sw $6,  24($k0)
0x00000520  0xaf47001c  sw $7,28($26)         531      sw $7,  28($k0)
0x00000524  0xaf480020  sw $8,32($26)         532      sw $8,  32($k0)
0x00000528  0xaf490024  sw $9,36($26)         533      sw $9,  36($k0)
0x0000052c  0xaf4a0028  sw $10,40($26)        534      sw $10, 40($k0)
0x00000530  0xaf4b002c  sw $11,44($26)        535      sw $11, 44($k0)
0x00000534  0xaf4c0030  sw $12,48($26)        536      sw $12, 48($k0)
0x00000538  0xaf4d0034  sw $13,52($26)        537      sw $13, 52($k0)
0x0000053c  0xaf4e0038  sw $14,56($26)        538      sw $14, 56($k0)
0x00000540  0xaf4f003c  sw $15,60($26)        539      sw $15, 60($k0)
0x00000544  0xaf500040  sw $16,64($26)        540      sw $16, 64($k0)
0x00000548  0xaf510044  sw $17,68($26)        541      sw $17, 68($k0)
0x0000054c  0xaf520048  sw $18,72($26)        542      sw $18, 72($k0)
0x00000550  0xaf53004c  sw $19,76($26)        543      sw $19, 76($k0)
0x00000554  0xaf540050  sw $20,80($26)        544      sw $20, 80($k0)
0x00000558  0xaf550054  sw $21,84($26)        545      sw $21, 84($k0)
0x0000055c  0xaf560058  sw $22,88($26)        546      sw $22, 88($k0)
0x00000560  0xaf57005c  sw $23,92($26)        547      sw $23, 92($k0)
0x00000564  0xaf580060  sw $24,96($26)        548      sw $24, 96($k0)
0x00000568  0xaf590064  sw $25,100($26)       549      sw $25, 100($k0) 
0x0000056c  0xaf5c0070  sw $28,112($26)       552      sw $28, 112($k0)
0x00000570  0xaf5d0074  sw $29,116($26)       553      sw $29, 116($k0)
0x00000574  0xaf5e0078  sw $30,120($26)       554      sw $30, 120($k0)
0x00000578  0xaf5f007c  sw $31,124($26)       555      sw $31, 124($k0)
0x0000057c  0x8c1a7fe4  lw $26,32740($0)      561    lw $k0, 0x7FE4($0)  #last task
0x00000580  0x8c1b7fe0  lw $27,32736($0)      562    lw $k1, 0x7FE0($0)  #status register
0x00000584  0x1340000c  beq $26,$0,12         564    beq $k0, $0, caseSchedLast0
0x00000588  0x001ad042  srl $26,$26,1         565    srl $k0, $k0, 1
0x0000058c  0x1340000d  beq $26,$0,13         566    beq $k0, $0, caseSchedLast1
0x00000590  0x001ad042  srl $26,$26,1         567    srl $k0, $k0, 1
0x00000594  0x1340000e  beq $26,$0,14         568    beq $k0, $0, caseSchedLast2
0x00000598  0x001ad042  srl $26,$26,1         569    srl $k0, $k0, 1
0x0000059c  0x1340000f  beq $26,$0,15         570    beq $k0, $0, caseSchedLast3
0x000005a0  0x001ad042  srl $26,$26,1         571    srl $k0, $k0, 1
0x000005a4  0x13400010  beq $26,$0,16         572    beq $k0, $0, caseSchedLast4
0x000005a8  0x001ad042  srl $26,$26,1         573    srl $k0, $k0, 1
0x000005ac  0x13400011  beq $26,$0,17         574    beq $k0, $0, caseSchedLast5
0x000005b0  0x001ad042  srl $26,$26,1         575    srl $k0, $k0, 1
0x000005b4  0x13400012  beq $26,$0,18         576    beq $k0, $0, caseSchedLast6
0x000005b8  0x201f0002  addi $31,$0,2         580      addi $31, $0, 2
0x000005bc  0x03fb4024  and $8,$31,$27        581      and $8, $31, $k1
0x000005c0  0x15000015  bne $8,$0,21          582      bne $8, $0, caseSchedNext1
0x000005c4  0x201f0004  addi $31,$0,4         584      addi $31, $0, 4    #2^next
0x000005c8  0x03fb4024  and $8,$31,$27        585      and $8, $31, $k1
0x000005cc  0x15000014  bne $8,$0,20          586      bne $8, $0, caseSchedNext2
0x000005d0  0x201f0008  addi $31,$0,8         588      addi $31, $0, 8
0x000005d4  0x03fb4024  and $8,$31,$27        589      and $8, $31, $k1
0x000005d8  0x15000013  bne $8,$0,19          590      bne $8, $0, caseSchedNext3
0x000005dc  0x201f0010  addi $31,$0,16        592      addi $31, $0, 16
0x000005e0  0x03fb4024  and $8,$31,$27        593      and $8, $31, $k1
0x000005e4  0x15000012  bne $8,$0,18          594      bne $8, $0, caseSchedNext4
0x000005e8  0x201f0020  addi $31,$0,32        596      addi $31, $0, 32
0x000005ec  0x03fb4024  and $8,$31,$27        597      and $8, $31, $k1
0x000005f0  0x15000011  bne $8,$0,17          598      bne $8, $0, caseSchedNext5
0x000005f4  0x201f0040  addi $31,$0,64        600      addi $31, $0, 64
0x000005f8  0x03fb4024  and $8,$31,$27        601      and $8, $31, $k1
0x000005fc  0x15000010  bne $8,$0,16          602      bne $8, $0, caseSchedNext6
0x00000600  0x201f0001  addi $31,$0,1         604      addi $31, $0, 1
0x00000604  0x03fb4024  and $8,$31,$27        605      and $8, $31, $k1
0x00000608  0x15000001  bne $8,$0,1           606      bne $8, $0, caseSchedNext0
0x0000060c  0x1000ffea  beq $0,$0,-22         608    beq $zero, $zero, caseSchedLast0 #circular list
0x00000610  0x201a6000  addi $26,$0,24576     613      addi $k0, $0, 0x6000
0x00000614  0x1000000b  beq $0,$0,11          614      beq $zero, $zero, caseSchedNextEnd
0x00000618  0x201a6100  addi $26,$0,24832     616      addi $k0, $0, 0x6100
0x0000061c  0x10000009  beq $0,$0,9           617      beq $zero, $zero, caseSchedNextEnd
0x00000620  0x201a6200  addi $26,$0,25088     619      addi $k0, $0, 0x6200
0x00000624  0x10000007  beq $0,$0,7           620      beq $zero, $zero, caseSchedNextEnd
0x00000628  0x201a6300  addi $26,$0,25344     622      addi $k0, $0, 0x6300
0x0000062c  0x10000005  beq $0,$0,5           623      beq $zero, $zero, caseSchedNextEnd
0x00000630  0x201a6400  addi $26,$0,25600     625      addi $k0, $0, 0x6400
0x00000634  0x10000003  beq $0,$0,3           626      beq $zero, $zero, caseSchedNextEnd
0x00000638  0x201a6500  addi $26,$0,25856     628      addi $k0, $0, 0x6500
0x0000063c  0x10000001  beq $0,$0,1           629      beq $zero, $zero, caseSchedNextEnd
0x00000640  0x201a6600  addi $26,$0,26112     631      addi $k0, $0, 0x6600
0x00000644  0x001ff9c0  sll $31,$31,7         635    sll $31, $31, 7
0x00000648  0x037fd825  or $27,$27,$31        636    or $k1, $k1, $31
0x0000064c  0xac1b7fe0  sw $27,32736($0)      637    sw $k1, 0x7FE0($0)
0x00000650  0x20080001  addi $8,$0,1          642    addi $8, $0, 1
0x00000654  0x00084380  sll $8,$8,14          643    sll $8, $8, 14  #location of init bit in status register
0x00000658  0x0368f824  and $31,$27,$8        644    and $31, $k1, $8
0x0000065c  0x13e00008  beq $31,$0,8          645    beq $31, $0 finishSchedUp
0x00000660  0x3c010000  lui $1,0              648    addi $31, $0, 0xFFFF
0x00000664  0x3421ffff  ori $1,$1,65535            
...
0x00000674  0xac1b7fe0  sw $27,32736($0)      651    sw $k1, 0x7FE0($0)
0x00000678  0x201f0744  addi $31,$0,1860      655    la $31, task0Start
0x0000067c  0xac1f7ff4  sw $31,32756($0)      656    sw $31, 0x7FF4($0)
0x00000680  0x8f5b0000  lw $27,0($26)         660      lw $k1, 0($k0)
0x00000684  0xac1b7ee0  sw $27,32480($0)      662      sw $k1, 0x7EE0($0)
0x00000688  0x8f410004  lw $1,4($26)          663      lw $1,  4($k0)
0x0000068c  0x8f420008  lw $2,8($26)          664      lw $2,  8($k0)
0x00000690  0x8f43000c  lw $3,12($26)         665      lw $3,  12($k0)
0x00000694  0x8f440010  lw $4,16($26)         666      lw $4,  16($k0)
0x00000698  0x8f450014  lw $5,20($26)         667      lw $5,  20($k0)
0x0000069c  0x8f460018  lw $6,24($26)         668      lw $6,  24($k0)
0x000006a0  0x8f47001c  lw $7,28($26)         669      lw $7,  28($k0)
0x000006a4  0x8f480020  lw $8,32($26)         670      lw $8,  32($k0)
0x000006a8  0x8f490024  lw $9,36($26)         671      lw $9,  36($k0)
0x000006ac  0x8f4a0028  lw $10,40($26)        672      lw $10, 40($k0)
0x000006b0  0x8f4b002c  lw $11,44($26)        673      lw $11, 44($k0)
0x000006b4  0x8f4c0030  lw $12,48($26)        674      lw $12, 48($k0)
0x000006b8  0x8f4d0034  lw $13,52($26)        675      lw $13, 52($k0)
0x000006bc  0x8f4e0038  lw $14,56($26)        676      lw $14, 56($k0)
0x000006c0  0x8f4f003c  lw $15,60($26)        677      lw $15, 60($k0)
0x000006c4  0x8f500040  lw $16,64($26)        678      lw $16, 64($k0)
0x000006c8  0x8f510044  lw $17,68($26)        679      lw $17, 68($k0)
0x000006cc  0x8f520048  lw $18,72($26)        680      lw $18, 72($k0)
0x000006d0  0x8f53004c  lw $19,76($26)        681      lw $19, 76($k0)
0x000006d4  0x8f540050  lw $20,80($26)        682      lw $20, 80($k0)
0x000006d8  0x8f550054  lw $21,84($26)        683      lw $21, 84($k0)
0x000006dc  0x8f560058  lw $22,88($26)        684      lw $22, 88($k0)
0x000006e0  0x8f57005c  lw $23,92($26)        685      lw $23, 92($k0)
0x000006e4  0x8f580060  lw $24,96($26)        686      lw $24, 96($k0)
0x000006e8  0x8f590064  lw $25,100($26)       687      lw $25, 100($k0)
0x000006ec  0x8f5c0070  lw $28,112($26)       690      lw $28, 112($k0)
0x000006f0  0x8f5d0074  lw $29,116($26)       691      lw $29, 116($k0)
0x000006f4  0x8f5e0078  lw $30,120($26)       692      lw $30, 120($k0)
0x000006f8  0x8f5f007c  lw $31,124($26)       695      lw $31, 124($k0)
0x000006fc  0xac1f7ee4  sw $31,32484($0)      696      sw $31, 0x7EE4($0)
0x00000700  0xac087eec  sw $8,32492($0)       698      sw $8,  0x7EEC($0)
0x00000704  0x8c1f7ff4  lw $31,32756($0)      700      lw $ra, 0x7FF4($0) #retrieve regs from beggining
0x00000708  0x8c1b7ff8  lw $27,32760($0)      701      lw $k1, 0x7FF8($0)
0x0000070c  0x8c087ffc  lw $8,32764($0)       702      lw $t0, 0x7FFC($0)
...
0x00000750  0xafaafffc  sw $10,-4($29)        727        sw   $t2, -4($sp)     # F[1] = F[0] = 1
0x00000754  0x21a9fffe  addi $9,$13,-2        728        addi $t1, $t5, -2     # Counter for loop, will execute (size-2) times
0x00000758  0x8fab0000  lw $11,0($29)         729  loop: lw   $t3, 0($sp)      # Get value from array F[n] 
0x0000075c  0x8facfffc  lw $12,-4($29)        730        lw   $t4, -4($sp)     # Get value from array F[n+1]
0x00000760  0x016c5020  add $10,$11,$12       731        add  $t2, $t3, $t4    # $t2 = F[n] + F[n+1]
0x00000764  0xafaafff8  sw $10,-8($29)        732        sw   $t2, -8($sp)     # Store F[n+2] = F[n] + F[n+1] in array
0x00000768  0x23bdfffc  addi $29,$29,-4       733        addi $sp, $sp, -4     # increment address of Fib. number source
0x0000076c  0x2129ffff  addi $9,$9,-1         734        addi $t1, $t1, -1     # decrement loop counter
0x00000770  0x1520fff9  bne $9,$0,-7          735        bne  $t1, $zero, loop # repeat if not finished yet.
0x00000774  0x1000fff3  beq $0,$0,-13         736  beq $zero, $zero, PROC_TASK_FIBONACCI # Keep running the task forever
...
0x000007ac  0x200a1100  addi $10,$0,4352      761      addi $t2, $zero, 0x1100
0x000007b0  0x200b3322  addi $11,$0,13090     762      addi $t3, $zero, 0x3322
0x000007b4  0x200c1100  addi $12,$0,4352      763      addi $t4, $zero, 0x1100
0x000007b8  0x200d3322  addi $13,$0,13090     764      addi $t5, $zero, 0x3322
0x000007bc  0x200e1100  addi $14,$0,4352      765      addi $t6, $zero, 0x1100
0x000007c0  0x200f3322  addi $15,$0,13090     766      addi $t7, $zero, 0x3322
...
0x000007e4  0x20080073  addi $8,$0,115        780      addi $t0, $zero, 0x73
0x000007e8  0x00084200  sll $8,$8,8           781      sll $t0, $t0, 0x8
0x000007ec  0x21080069  addi $8,$8,105        782      addi $t0, $t0, 0x69
0x000007f0  0x00084200  sll $8,$8,8           783      sll $t0, $t0, 0x8
0x000007f4  0x21080068  addi $8,$8,104        784      addi $t0, $t0, 0x68
0x000007f8  0x00084200  sll $8,$8,8           785      sll $t0, $t0, 0x8
0x000007fc  0x21080054  addi $8,$8,84         786      addi $t0, $t0, 0x54
0x00000800  0xafa80000  sw $8,0($29)          787      sw $t0, 0x0($sp)
0x00000804  0x23bdfffc  addi $29,$29,-4       788      addi $sp, $sp, -0x4
0x00000808  0x20080078  addi $8,$0,120        790      addi $t0, $zero, 0x78
0x0000080c  0x00084200  sll $8,$8,8           791      sll $t0, $t0, 0x8
0x00000810  0x21080065  addi $8,$8,101        792      addi $t0, $t0, 0x65
0x00000814  0x00084200  sll $8,$8,8           793      sll $t0, $t0, 0x8
0x00000818  0x21080074  addi $8,$8,116        794      addi $t0, $t0, 0x74
0x0000081c  0x00084200  sll $8,$8,8           795      sll $t0, $t0, 0x8
0x00000820  0x21080020  addi $8,$8,32         796      addi $t0, $t0, 0x20
0x00000824  0xafa80000  sw $8,0($29)          797      sw $t0, 0x0($sp)
0x00000828  0x23bdfffc  addi $29,$29,-4       798      addi $sp, $sp, -0x4
0x0000082c  0x20080073  addi $8,$0,115        800      addi $t0, $zero, 0x73
0x00000830  0x00084200  sll $8,$8,8           801      sll $t0, $t0, 0x8
0x00000834  0x20080069  addi $8,$0,105        802      addi $t0, $zero, 0x69
0x00000838  0x00084200  sll $8,$8,8           803      sll $t0, $t0, 0x8
0x0000083c  0x20080020  addi $8,$0,32         804      addi $t0, $zero, 0x20
0x00000840  0x00084200  sll $8,$8,8           805      sll $t0, $t0, 0x8
0x00000844  0x20080074  addi $8,$0,116        806      addi $t0, $zero, 0x74
0x00000848  0xafa80000  sw $8,0($29)          807      sw $t0, 0x0($sp)
0x0000084c  0x23bdfffc  addi $29,$29,-4       808      addi $sp, $sp, -0x4
0x00000850  0x20080073  addi $8,$0,115        810      addi $t0, $zero, 0x73
0x00000854  0x00084200  sll $8,$8,8           811      sll $t0, $t0, 0x8
0x00000858  0x20080020  addi $8,$0,32         812      addi $t0, $zero, 0x20
0x0000085c  0x00084200  sll $8,$8,8           813      sll $t0, $t0, 0x8
0x00000860  0x20080061  addi $8,$0,97         814      addi $t0, $zero, 0x61
0x00000864  0x00084200  sll $8,$8,8           815      sll $t0, $t0, 0x8
0x00000868  0x20080020  addi $8,$0,32         816      addi $t0, $zero, 0x20
0x0000086c  0xafa80000  sw $8,0($29)          817      sw $t0, 0x0($sp)
0x00000870  0x23bdfffc  addi $29,$29,-4       818      addi $sp, $sp, -0x4
0x00000874  0x20080072  addi $8,$0,114        820      addi $t0, $zero, 0x72
0x00000878  0x00084200  sll $8,$8,8           821      sll $t0, $t0, 0x8
0x0000087c  0x20080065  addi $8,$0,101        822      addi $t0, $zero, 0x65
0x00000880  0x00084200  sll $8,$8,8           823      sll $t0, $t0, 0x8
0x00000884  0x20080070  addi $8,$0,112        824      addi $t0, $zero, 0x70
0x00000888  0x00084200  sll $8,$8,8           825      sll $t0, $t0, 0x8
0x0000088c  0x20080075  addi $8,$0,117        826      addi $t0, $zero, 0x75
0x00000890  0xafa80000  sw $8,0($29)          827      sw $t0, 0x0($sp)
0x00000894  0x23bdfffc  addi $29,$29,-4       828      addi $sp, $sp, -0x4
0x00000898  0x20080063  addi $8,$0,99         830      addi $t0, $zero, 0x63
0x0000089c  0x00084200  sll $8,$8,8           831      sll $t0, $t0, 0x8
0x000008a0  0x20080065  addi $8,$0,101        832      addi $t0, $zero, 0x65
0x000008a4  0x00084200  sll $8,$8,8           833      sll $t0, $t0, 0x8
0x000008a8  0x20080073  addi $8,$0,115        834      addi $t0, $zero, 0x73
0x000008ac  0x00084200  sll $8,$8,8           835      sll $t0, $t0, 0x8
0x000008b0  0x20080020  addi $8,$0,32         836      addi $t0, $zero, 0x20
0x000008b4  0xafa80000  sw $8,0($29)          837      sw $t0, 0x0($sp)
0x000008b8  0x23bdfffc  addi $29,$29,-4       838      addi $sp, $sp, -0x4
0x000008bc  0x20080020  addi $8,$0,32         840      addi $t0, $zero, 0x20
0x000008c0  0x00084200  sll $8,$8,8           841      sll $t0, $t0, 0x8
0x000008c4  0x20080074  addi $8,$0,116        842      addi $t0, $zero, 0x74
0x000008c8  0x00084200  sll $8,$8,8           843      sll $t0, $t0, 0x8
0x000008cc  0x20080065  addi $8,$0,101        844      addi $t0, $zero, 0x65
0x000008d0  0x00084200  sll $8,$8,8           845      sll $t0, $t0, 0x8
0x000008d4  0x20080072  addi $8,$0,114        846      addi $t0, $zero, 0x72
0x000008d8  0xafa80000  sw $8,0($29)          847      sw $t0, 0x0($sp)
0x000008dc  0x23bdfffc  addi $29,$29,-4       848      addi $sp, $sp, -0x4
0x000008e0  0x20080069  addi $8,$0,105        850      addi $t0, $zero, 0x69
0x000008e4  0x00084200  sll $8,$8,8           851      sll $t0, $t0, 0x8
0x000008e8  0x20080062  addi $8,$0,98         852      addi $t0, $zero, 0x62
0x000008ec  0x00084200  sll $8,$8,8           853      sll $t0, $t0, 0x8
0x000008f0  0x20080020  addi $8,$0,32         854      addi $t0, $zero, 0x20
0x000008f4  0x00084200  sll $8,$8,8           855      sll $t0, $t0, 0x8
0x000008f8  0x20080038  addi $8,$0,56         856      addi $t0, $zero, 0x38
0x000008fc  0xafa80000  sw $8,0($29)          857      sw $t0, 0x0($sp)
0x00000900  0x23bdfffc  addi $29,$29,-4       858      addi $sp, $sp, -0x4
0x00000904  0x20080065  addi $8,$0,101        860      addi $t0, $zero, 0x65
0x00000908  0x00084200  sll $8,$8,8           861      sll $t0, $t0, 0x8
0x0000090c  0x2008006d  addi $8,$0,109        862      addi $t0, $zero, 0x6d
0x00000910  0x00084200  sll $8,$8,8           863      sll $t0, $t0, 0x8
0x00000914  0x20080020  addi $8,$0,32         864      addi $t0, $zero, 0x20
0x00000918  0x00084200  sll $8,$8,8           865      sll $t0, $t0, 0x8
0x0000091c  0x20080074  addi $8,$0,116        866      addi $t0, $zero, 0x74
0x00000920  0xafa80000  sw $8,0($29)          867      sw $t0, 0x0($sp)
0x00000924  0x23bdfffc  addi $29,$29,-4       868      addi $sp, $sp, -0x4
0x00000928  0x20080067  addi $8,$0,103        870      addi $t0, $zero, 0x67
0x0000092c  0x00084200  sll $8,$8,8           871      sll $t0, $t0, 0x8
0x00000930  0x20080061  addi $8,$0,97         872      addi $t0, $zero, 0x61
0x00000934  0x00084200  sll $8,$8,8           873      sll $t0, $t0, 0x8
0x00000938  0x20080073  addi $8,$0,115        874      addi $t0, $zero, 0x73
0x0000093c  0x00084200  sll $8,$8,8           875      sll $t0, $t0, 0x8
0x00000940  0x20080073  addi $8,$0,115        876      addi $t0, $zero, 0x73
0x00000944  0xafa80000  sw $8,0($29)          877      sw $t0, 0x0($sp)
0x00000948  0x23bdfffc  addi $29,$29,-4       878      addi $sp, $sp, -0x4
0x0000094c  0x20080065  addi $8,$0,101        880      addi $t0, $zero, 0x65
0x00000950  0x00084200  sll $8,$8,8           881      sll $t0, $t0, 0x8
0x00000954  0x20080068  addi $8,$0,104        882      addi $t0, $zero, 0x68
0x00000958  0x00084200  sll $8,$8,8           883      sll $t0, $t0, 0x8
0x0000095c  0x20080020  addi $8,$0,32         884      addi $t0, $zero, 0x20
0x00000960  0x00084200  sll $8,$8,8           885      sll $t0, $t0, 0x8
0x00000964  0x20080065  addi $8,$0,101        886      addi $t0, $zero, 0x65
0x00000968  0xafa80000  sw $8,0($29)          887      sw $t0, 0x0($sp)
0x0000096c  0x23bdfffc  addi $29,$29,-4       888      addi $sp, $sp, -0x4
0x00000970  0x20080000  addi $8,$0,0          890      addi $t0, $zero, 0x00
0x00000974  0x00084200  sll $8,$8,8           891      sll $t0, $t0, 0x8
0x00000978  0x2008002e  addi $8,$0,46         892      addi $t0, $zero, 0x2e
0x0000097c  0x00084200  sll $8,$8,8           893      sll $t0, $t0, 0x8
0x00000980  0x20080065  addi $8,$0,101        894      addi $t0, $zero, 0x65
0x00000984  0x00084200  sll $8,$8,8           895      sll $t0, $t0, 0x8
0x00000988  0x20080072  addi $8,$0,114        896      addi $t0, $zero, 0x72
0x0000098c  0xafa80000  sw $8,0($29)          897      sw $t0, 0x0($sp)
0x00000990  0x23bdfffc  addi $29,$29,-4       898      addi $sp, $sp, -0x4
0x00000994  0x23d00000  addi $16,$30,0        900      addi $s0, $fp, 0x0 # Set up a pointer to give to the AES
0x00000998  0x2011000c  addi $17,$0,12        901      addi $s1, $zero, 12 # Number of words to encrypt
0x0000099c  0x20120d0a  addi $18,$0,3338      902      addi $s2, $zero, 0x0d0a
0x000009a0  0x001293c0  sll $18,$18,15        903      sll $s2, $s2, 0xF # Set up a register that I can randomly print newline with
0x000009a4  0xac127000  sw $18,28672($0)      904      sw $s2, 0x7000($zero)
0x000009a8  0xac127000  sw $18,28672($0)      905      sw $s2, 0x7000($zero) # Write a couple newlines
0x000009ac  0x40900800  mtc0 $16,$1           919      mtc0 $s0, $1
0x000009b0  0x20090005  addi $9,$0,5          920      addi $t1, $zero, 0x5 # Set encrypt at 256 bit mode
0x000009b4  0x00094bc0  sll $9,$9,15          921      sll $t1, $t1, 0xF
0x000009b8  0x01314820  add $9,$9,$17         922      add $t1, $t1, $s1
0x000009bc  0x40890000  mtc0 $9,$0            923      mtc0 $t1, $0
0x000009c0  0x200a0001  addi $10,$0,1         926      addi $t2, $zero, 0x1
0x000009c4  0x8c097028  lw $9,28712($0)       928          lw $t1, 0x7028($zero)
0x000009c8  0x152afffe  bne $9,$10,-2         929          bne $t1, $t2, SPINLOCK_1
0x000009cc  0xac127000  sw $18,28672($0)      930      sw $s2, 0x7000($zero) # N2: Write to CRLFs
0x000009d0  0xac127000  sw $18,28672($0)      931      sw $s2, 0x7000($zero)
0x000009d4  0xac007028  sw $0,28712($0)       932      sw $zero, 0x7028($zero) # Reset AES done flag
0x000009d8  0x40900800  mtc0 $16,$1           949      mtc0 $s0, $1
0x000009dc  0x20090004  addi $9,$0,4          950      addi $t1, $zero, 0x4 # Set decrypt at 256 bit mode
0x000009e0  0x00094bc0  sll $9,$9,15          951      sll $t1, $t1, 0xF
0x000009e4  0x01314820  add $9,$9,$17         952      add $t1, $t1, $s1
0x000009e8  0x40890000  mtc0 $9,$0            953      mtc0 $t1, $0
0x000009ec  0x200a0001  addi $10,$0,1         956      addi $t2, $zero, 0x1
0x000009f0  0x8c097028  lw $9,28712($0)       958          lw $t1, 0x7028($zero)
0x000009f4  0x152afffe  bne $9,$10,-2         959          bne $t1, $t2, SPINLOCK_2
0x000009f8  0xac127000  sw $18,28672($0)      960      sw $s2, 0x7000($zero) # N2: Write to CRLFs
0x000009fc  0xac127000  sw $18,28672($0)      961      sw $s2, 0x7000($zero)
0x00000a00  0xac007028  sw $0,28712($0)       962      sw $zero, 0x7028($zero) # Reset AES done flag
0x00000a04  0x00104820  add $9,$0,$16         965      add $t1, $zero, $s0 # Set up a pointer to start loading the phrase
0x00000a08  0x212affd0  addi $10,$9,-48       966      addi $t2, $t1, -48 # End pointer is 48 bytes away
0x00000a0c  0x8d2b0000  lw $11,0($9)          968          lw $t3, 0x0($t1)
0x00000a10  0xac0b7000  sw $11,28672($0)      969          sw $t3, 0x7000($zero)
0x00000a14  0x2129fffc  addi $9,$9,-4         970          addi $t1, $t1, -0x4
0x00000a18  0x152afffc  bne $9,$10,-4         971          bne $t1, $t2, WRITE_OUT3
0x00000a1c  0xac127000  sw $18,28672($0)      972      sw $s2, 0x7000($zero) # N2: Write to CRLFs
0x00000a20  0xac127000  sw $18,28672($0)      973      sw $s2, 0x7000($zero)
...
0x00000a44  0x00000000  nop                   985  nop
...
0x00000a68  0x00000000  nop                   995  nop
